 ...
 *      * A filter `searchwp_modal_form.nav_menu_item_fields` is added to allow filtering `$nav_menu_item_fields`.
 */
class SearchWPModalFormMenuWalker extends Walker_Nav_Menu_Edit {
	...
	public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
		...
		<li id="menu-item-<?php echo $item_id; ?>" class="<?php echo implode( ' ', $classes ); ?>">
			...
			<div class="menu-item-settings wp-clearfix" id="menu-item-settings-<?php echo $item_id; ?>">
				 ...
				 */
				$walker = $this;
				$nav_menu_item_fields = apply_filters( 'searchwp_modal_form.nav_menu_item_fields', $nav_menu_item_fields, compact( 'item', 'depth', 'walker' ) );
