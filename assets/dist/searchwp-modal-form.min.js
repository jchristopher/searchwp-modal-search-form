...
},{}],"p9/1":[function(require,module,exports) {
"use strict";var e=r(require("micromodal")),t=r(require("domready"));function r(e){return e&&e.__esModule?e:{default:e}}e.default.init({onShow:function(e){var t=e.querySelectorAll('[name="s"]')[0];t.focus(),t.select()}}),(0,t.default)(function(){var t="",r=document.querySelectorAll("[data-searchwp-modal-trigger]"),a=document.querySelectorAll("[data-searchwp-modal-form-close]");r.forEach(function(r){r.addEventListener("click",function(r){r.preventDefault();var a=r.currentTarget.getAttribute("data-searchwp-modal-trigger");t=a,e.default.show(a)},!1)}),a.forEach(function(r){r.addEventListener("click",function(r){r.currentTarget.hasAttribute("data-searchwp-modal-form-close")&&(r.preventDefault(),e.default.close(t),t="")},!0)})});
},{"micromodal":"kf3M","domready":"HLDr"}]},{},["p9/1"], null)
//# sourceMappingURL=/searchwp-modal-form.min.js.map